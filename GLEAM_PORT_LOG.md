...
## 2026-04-30 — Pass 39: gift-card parity completion
...
--target javascript` was green at 715 tests. `gleam test --target erlang` was
green at 712 tests via the `ghcr.io/gleam-lang/gleam:v1.16.0-erlang-alpine`
