...
## 2026-05-01 - Pass 165: bulk operations query and import parity
...
local Erlang runner issue. The established container fallback is green at 772
tests with OTP 28:
...
Host `gleam test --target javascript` is green at 776 tests.
`corepack pnpm gleam:port:coverage` is green with 379 parity specs and 61
