...
## 2026-05-01 - Pass 115: bulk operations query and import parity
...
fallback is green at 719 tests with OTP 28:
...
Host `gleam test --target javascript` is green at 723 tests.
`corepack pnpm gleam:port:coverage` is green with 379 parity specs and 175
