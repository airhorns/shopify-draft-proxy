...
import shopify_draft_proxy/state/types.{
  ...
  type ProductMetafieldRecord, type PublicationRecord, type ShopRecord,
  CapturedArray, CapturedBool, CapturedNull, CapturedObject, CapturedString,
  CatalogRecord, MarketLocalizableContentRecord, MarketRecord,
  PaymentSettingsRecord, PriceListRecord, ProductMetafieldRecord,
