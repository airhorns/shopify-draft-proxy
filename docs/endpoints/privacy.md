...
- Local data-sale opt-out staging and read-after-write behavior: `gleam/test/parity_test.gleam`
- Privacy mutation observability and capability behavior: `gleam/test/parity_test.gleam`
