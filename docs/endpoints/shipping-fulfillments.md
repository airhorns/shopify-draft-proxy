...
- `fulfillmentOrderReschedule`, `fulfillmentOrderClose`, `fulfillmentOrdersReroute`, and `fulfillmentOrderLineItemsPreparedForPickup` remain registry-only/full-support gaps except for captured guardrail branches already called out above.
