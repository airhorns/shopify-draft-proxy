...
- `gleam/test/parity_test.gleam` covers no-upstream local staging and mutation-log preservation for the lifecycle roots.
- `gleam/test/parity_test.gleam` covers top-level fulfillment/fulfillment-order reads, manual holds, and local `assignedFulfillmentOrders` assignment-status/location filters.
...
- Implemented order-scoped fulfillments: `gleam/test/parity_test.gleam`
- Implemented top-level fulfillment reads: `gleam/test/parity_test.gleam`
- Implemented fulfillment services: `gleam/test/parity_test.gleam`
- Implemented carrier services: `gleam/test/parity_test.gleam`
- Implemented delivery settings reads: `gleam/test/parity_test.gleam`
- Implemented shipping settings/package/pickup slice: `gleam/test/parity_test.gleam`
- Implemented delivery-profile reads: `gleam/test/parity_test.gleam`
- Implemented delivery-profile writes: `gleam/test/parity_test.gleam`
