...
- `test/parity_test.gleam` covers no-upstream local staging and mutation-log preservation for the lifecycle roots.
- `test/parity_test.gleam` covers top-level fulfillment/fulfillment-order reads, manual holds, and local `assignedFulfillmentOrders` assignment-status/location filters.
...
- Implemented order-scoped fulfillments: `test/parity_test.gleam`
- Implemented top-level fulfillment reads: `test/parity_test.gleam`
- Implemented fulfillment services: `test/parity_test.gleam`
- Implemented carrier services: `test/parity_test.gleam`
- Implemented delivery settings reads: `test/parity_test.gleam`
- Implemented shipping settings/package/pickup slice: `test/parity_test.gleam`
- Implemented delivery-profile reads: `test/parity_test.gleam`
- Implemented delivery-profile writes: `test/parity_test.gleam`
