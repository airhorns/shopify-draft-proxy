...
- Conformance evidence: `fixtures/conformance/harry-test-heelo.myshopify.com/2026-04/admin-platform-utility-roots.json`, plus market-region country evidence in `fixtures/conformance/harry-test-heelo.myshopify.com/2026-04/markets-baseline.json` and `fixtures/conformance/very-big-test-store.myshopify.com/2026-04/markets-baseline.json`.
