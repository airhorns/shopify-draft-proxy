...
- Adjacent Markets roots such as top-level `webPresences` and `marketsResolvedValues` still replay captured root payload slices until deeper normalized models are added for those resources.
