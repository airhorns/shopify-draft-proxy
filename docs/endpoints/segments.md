...
- Segment reads: `test/parity_test.gleam`
- Segment lifecycle: `test/parity_test.gleam`
- Customer segment members: `test/parity_test.gleam`
...
- HAR-458 review coverage: `test/parity_test.gleam` covers segmentId-backed member query
