...
- Future discount work should expand live app-discount fixtures once a discount Function exists, tighten Shopify-specific app-discount validation/userError codes, and capture more complex redeem-code search/saved-search deletion semantics beyond the current local code matcher.
