...
- Automatic-basic lifecycle tests cover create-read-update-activate/deactivate-delete flows, customer/segment buyer-context links, and downstream reads. The live 2026-04 fixtures `discount-automatic-basic-lifecycle.json` and `discount-automatic-basic-nodes-read.json` anchor the automatic lifecycle payload and read shapes.
