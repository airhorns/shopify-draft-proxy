...
- Versioned request-contract note: HAR-408 captured Admin GraphQL 2026-04 inventory quantity drift in `fixtures/conformance/harry-test-heelo.myshopify.com/2026-04/products/inventory-quantity-contracts-2026-04.json`. The parity runner exercises the missing `changeFromQuantity` set branch, the missing `changeFromQuantity` adjust branch, successful set/adjust writes, and downstream read effects on 2026-04 proxy requests; `tests/integration/inventory-quantity-roots.test.ts` replays the remaining route-specific validation and success branches through `/admin/api/2026-04/graphql.json`.
...
- Inventory adjustment and quantity roots: `tests/integration/product-draft-flow.test.ts`, `tests/integration/inventory-quantity-roots.test.ts`, `config/parity-specs/products/inventoryAdjustQuantities-parity-plan.json`, and `config/parity-specs/products/inventory-quantity-roots-parity.json`
- Inventory transfer lifecycle roots: `tests/integration/inventory-transfer-flow.test.ts`
- Inventory shipment lifecycle roots: `tests/integration/inventory-shipment-flow.test.ts`, `config/parity-specs/products/inventory-shipment-lifecycle-local-staging.json`, and `fixtures/conformance/local-runtime/2026-04/products/inventory-shipment-lifecycle-local-staging.json`
- Product reads: `tests/integration/product-query-shapes.test.ts`
- Product duplicate lifecycle: `tests/integration/product-draft-flow.test.ts`, `config/parity-specs/products/productDuplicate-parity-plan.json`, `config/parity-specs/products/productDuplicate-async-success.json`, and `config/parity-specs/products/productDuplicate-async-missing.json`
