...
- Runtime flows: `gleam/test/parity_test.gleam`
- Inventory adjustment and quantity roots: `gleam/test/parity_test.gleam`, `gleam/test/parity_test.gleam`, `config/parity-specs/products/inventoryAdjustQuantities-parity-plan.json`, and `config/parity-specs/products/inventory-quantity-roots-parity.json`
- Inventory transfer lifecycle roots: `gleam/test/parity_test.gleam`
- Inventory shipment lifecycle roots: `gleam/test/parity_test.gleam`, `config/parity-specs/products/inventory-shipment-lifecycle-local-staging.json`, and `fixtures/conformance/local-runtime/2026-04/products/inventory-shipment-lifecycle-local-staging.json`
- Product reads: `gleam/test/parity_test.gleam`
- Product duplicate lifecycle: `gleam/test/parity_test.gleam`, `config/parity-specs/products/productDuplicate-parity-plan.json`, `config/parity-specs/products/productDuplicate-async-success.json`, and `config/parity-specs/products/productDuplicate-async-missing.json`
- Collection reads and mutations: `gleam/test/parity_test.gleam`, `gleam/test/parity_test.gleam`
- Location and publication reads: `gleam/test/parity_test.gleam`, `gleam/test/parity_test.gleam`
