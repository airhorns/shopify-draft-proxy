...
- Root coverage snapshot: `corepack pnpm vitest run gleam/test/parity_test.gleam`
- Online-store routing guard: `corepack pnpm vitest run gleam/test/parity_test.gleam`
- Online-store content flow: `corepack pnpm exec vitest run gleam/test/parity_test.gleam`
- Online-store presentation/integration flow: `corepack pnpm exec vitest run gleam/test/parity_test.gleam`
