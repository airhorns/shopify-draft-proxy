...
- publication-status filters and `savedSearchId` are not modeled yet; they should stay tied to the collection publication work instead of pretending product publication state answers collection publication semantics
