...
- Rust runtime coverage locks the blank snapshot contract that unhydrated reads for sentinel IDs such as `gid://shopify/CustomerPaymentMethod/base-card` and Customer/8801 payment-method lists stay null/empty instead of reintroducing fabricated fixture records.
