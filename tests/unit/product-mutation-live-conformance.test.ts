...
type ProductMutationCapture = {
  validation?: ProductMutationValidationCapture | {
...
describe('product mutation live conformance wiring', () => {
  ...
  it('preserves live validation userErrors alongside the happy-path product mutation captures', () => {
    ...
    const createCapture = JSON.parse(
      readFileSync(resolve(repoRoot, 'fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-create-parity.json'), 'utf8'),
    ) as ProductMutationCapture;
    const updateCapture = JSON.parse(
      readFileSync(resolve(repoRoot, 'fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-update-parity.json'), 'utf8'),
    ) as ProductMutationCapture;
    const deleteCapture = JSON.parse(
      readFileSync(resolve(repoRoot, 'fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-delete-parity.json'), 'utf8'),
    ) as ProductMutationCapture;
