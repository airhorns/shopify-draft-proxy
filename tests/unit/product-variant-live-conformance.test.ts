...
describe('product variant live conformance coverage', () => {
  ...
  it('promotes the bulk variant mutation family to captured live parity', () => {
    expectCapturedScenario({
      ...
      captureFiles: ['fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-variants-bulk-create-parity.json'],
    ...
    expectCapturedScenario({
      ...
      captureFiles: ['fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-variants-bulk-update-parity.json'],
    ...
    expectCapturedScenario({
      ...
      captureFiles: ['fixtures/conformance/very-big-test-store.myshopify.com/2025-01/product-variants-bulk-delete-parity.json'],
