  ...
  it('promotes metafieldsSet, metafieldsDelete, and the singular metafieldDelete compatibility alias to covered live parity', () => {
    ...
    expect(registry).toContainEqual(
      expect.objectContaining({
        ...
        conformance: expect.objectContaining({
          status: 'covered',
          scenarioIds: ['metafields-set-live-parity'],
        }),
      }),
    );
    ...
    expect(registry).toContainEqual(
      expect.objectContaining({
        ...
        conformance: expect.objectContaining({
          status: 'covered',
          scenarioIds: ['metafields-delete-live-parity'],
        }),
      }),
    );
    ...
    expect(registry).toContainEqual(
      expect.objectContaining({
        ...
        conformance: expect.objectContaining({
          status: 'covered',
          scenarioIds: ['metafield-delete-compatibility-live-parity'],
        }),
      }),
    );
