...
fn fixed_percentage_pricing_policy(percentage: i64) -> Value {
    json!({
        "fixed": {
...
fn recurring_percentage_pricing_policy(percentage: i64, after_cycle: i64) -> Value {
    json!({
        "recurring": {
            "adjustmentType": "PERCENTAGE",
            "adjustmentValue": { "percentage": percentage },
        ...
        json!({
            ...
            "sellingPlansToCreate": [
                selling_plan_input_with_pricing_policies(
                    ...
                    vec!["Monthly"],
                    vec![recurring_percentage_pricing_policy(5, 2)],
                )
            ]
        }),
    );
        ...
        json!({
            ...
            "input": {
                "sellingPlansToUpdate": [{
                    "id": plan_id,
                    "pricingPolicies": [recurring_percentage_pricing_policy(5, 2)]
                }]
            }
        }),
    ));
            ...
            "input": {
                ...
                "sellingPlansToCreate": [
                    selling_plan_input_with_pricing_policies(
                        ...
                        vec!["Monthly"],
                        vec![
                            fixed_percentage_pricing_policy(10),
                            recurring_percentage_pricing_policy(5, 2),
                        ],
                    )
                ]
            }
