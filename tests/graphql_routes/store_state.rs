...
fn store_saved_searches_overlay_defaults_base_and_tombstones_in_order() {
    ...
    seed["runtimeState"]["store"]["savedSearches"]["base"] = json!({
        "records": {
        ...
        "order": ["gid://shopify/SavedSearch/base"]
    });
...
fn store_dump_restore_round_trips_order_and_tombstones() {
    ...
    let store = &mut body["runtimeState"]["store"];
    store["products"]["base"] = json!({
        "records": {
            "gid://shopify/Product/base-1": product(
                "gid://shopify/Product/base-1",
                "Base one",
                "base-one"
            ),
            "gid://shopify/Product/base-2": product(
                "gid://shopify/Product/base-2",
                "Base two",
                "base-two"
            )
        },
        "order": ["gid://shopify/Product/base-1", "gid://shopify/Product/base-2"]
    });
    store["products"]["staged"] = json!({
        "records": {
            "gid://shopify/Product/base-1": product(
                "gid://shopify/Product/base-1",
                "Updated one",
            ...
            "gid://shopify/Product/new": product(
                "gid://shopify/Product/new",
                "New product",
                "new-product"
            )
        },
        "order": ["gid://shopify/Product/base-1", "gid://shopify/Product/new"],
        "tombstones": ["gid://shopify/Product/base-2"]
    });
    store["savedSearches"]["staged"] = json!({
        "records": {
        ...
        "order": ["gid://shopify/SavedSearch/new"],
        "tombstones": []
    });
    store["staged"]["locations"] = json!({
        "records": {
        ...
        "order": ["gid://shopify/Location/live"],
        "tombstones": ["gid://shopify/Location/deleted"]
    });
    store["staged"]["deliveryProfiles"] = json!({
        "records": {
        ...
        "order": ["gid://shopify/DeliveryProfile/live"],
        "tombstones": ["gid://shopify/DeliveryProfile/deleted"]
    });
    store["staged"]["storeCreditAccounts"] = json!({
        "records": {
            "gid://shopify/StoreCreditAccount/1": {
                "id": "gid://shopify/StoreCreditAccount/1"
            }
        },
        "order": ["gid://shopify/StoreCreditAccount/1"],
        "tombstones": []
    });
    store["staged"]["b2bLocations"] = json!({
        "records": {
            "gid://shopify/CompanyLocation/1": {
                "id": "gid://shopify/CompanyLocation/1"
            }
        },
        "order": ["gid://shopify/CompanyLocation/1"],
        "tombstones": []
    });
    store["staged"]["customers"]["tombstones"] = json!(["gid://shopify/Customer/deleted"]);
    store["staged"]["collections"]["tombstones"] = json!(["gid://shopify/Collection/deleted"]);
    store["base"]["segments"] = json!({
        "records": {
        ...
        "order": ["gid://shopify/Segment/base-1", "gid://shopify/Segment/base-2"]
    });
    store["staged"]["segments"] = json!({
        "records": {
            "gid://shopify/Segment/base-1": {
                "id": "gid://shopify/Segment/base-1",
        ...
        "order": ["gid://shopify/Segment/base-1", "gid://shopify/Segment/new"],
        "tombstones": ["gid://shopify/Segment/base-2"]
    });
