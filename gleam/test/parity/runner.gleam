...
import shopify_draft_proxy/state/types.{
  ...
  type OnlineStoreContentRecord, type PaymentSettingsRecord,
  ...
  OnlineStoreContentRecord, PaymentSettingsRecord, ProductCategoryRecord,
...
fn seed_capture_preconditions(
  ...
  case parsed.scenario_id {
    ...
    "online-store-content-lifecycle" | "online-store-content-search-filters" ->
...
fn seed_online_store_content_preconditions(
  ...
  let records = case scenario_id {
    "online-store-content-lifecycle" ->
      list.append(
    ...
    "online-store-content-search-filters" ->
