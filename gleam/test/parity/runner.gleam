...
import shopify_draft_proxy/state/types.{
  ...
  CustomerSmsMarketingConsentRecord, DeliveryProfileRecord, DiscountRecord,
  DraftOrderRecord, DraftOrderVariantCatalogRecord, FulfillmentOrderRecord,
  FulfillmentRecord, GiftCardConfigurationRecord,
