...
import shopify_draft_proxy/state/types.{
  ...
  B2BCompanyLocationRecord, B2BCompanyRecord, BulkOperationRecord, CapturedArray,
  CapturedBool, CapturedFloat, CapturedInt, CapturedNull, CapturedObject,
  CapturedString, CatalogRecord, CollectionImageRecord, CollectionRecord,
  ...
  CustomerRecord, CustomerSmsMarketingConsentRecord, DiscountRecord,
