...
export const conformanceCaptureIndex = defineCaptureIndex([
  ...
  },
  {
    ...
    fixtureOutputs: [
      ...
      'config/parity-requests/products/setup-state/productVariantCreate-setup-state.json',
      'config/parity-requests/products/setup-state/productVariantUpdate-setup-state.json',
      'config/parity-requests/products/setup-state/productVariantDelete-setup-state.json',
    ],
