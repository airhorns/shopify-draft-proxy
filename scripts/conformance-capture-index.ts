...
export const conformanceCaptureIndex = defineCaptureIndex([
  ...
  },
  {
    ...
    purpose:
      'Product bulk variant create/update/delete mutations plus retained historical single-root compatibility evidence.',
    requiredAuthScopes: ['read_products', 'write_products'],
    fixtureOutputs: [
  ...
  },
  {
    ...
    expectedStatusChecks: DEFAULT_STATUS_CHECKS,
    notes:
      'The captured Admin schemas do not expose productVariantDelete. The retained historical comparison target uses equivalent one-id productVariantsBulkDelete janitor evidence; executable proxy requests use the schema-supported bulk root.',
  },
  {
    domain: 'products',
