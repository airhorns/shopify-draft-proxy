...
export const conformanceCaptureIndex = defineCaptureIndex([
  ...
  },
  {
    ...
    fixtureOutputs: [
      ...
      'config/parity-specs/products/product_feed_create_validation.json',
  ...
  },
  {
    ...
    fixtureOutputs: [
      ...
      'config/parity-specs/products/publication_delete_default_validation.json',
  ...
  },
  {
    ...
    fixtureOutputs: [
      ...
      'config/parity-specs/products/inventory-shipment-validation-local-runtime.json',
