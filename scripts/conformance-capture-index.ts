...
export const conformanceCaptureIndex = defineCaptureIndex([
  ...
  {
    domain: 'orders',
    captureId: 'orders-forged-evidence-retirement',
    scriptPath: 'scripts/capture-orders-forged-evidence-retirement.ts',
    purpose:
      'Registers retired orders local-runtime parity specs and stale descriptor-cassette refund fixture copies so they are no longer treated as Shopify parity evidence.',
    requiredAuthScopes: ['none; deletion-only retirement of forged parity evidence'],
    fixtureOutputs: [
    ...
    cleanupBehavior:
      'No Shopify cleanup; this entry documents deletion of previously checked-in forged parity evidence.',
    expectedStatusChecks: ['conformance:check', 'rust:test'],
  },
  {
    domain: 'orders',
    captureId: 'orders',
