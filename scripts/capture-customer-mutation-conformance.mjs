...
async function main() {
  ...
  await Promise.all([
    writeFile(path.join(outputDir, 'customer-create-parity.json'), `${JSON.stringify(createCapture, null, 2)}\n`, 'utf8'),
    writeFile(path.join(outputDir, 'customer-update-parity.json'), `${JSON.stringify(updateCapture, null, 2)}\n`, 'utf8'),
    writeFile(path.join(outputDir, 'customer-delete-parity.json'), `${JSON.stringify(deleteCapture, null, 2)}\n`, 'utf8'),
  ]);
  ...
  console.log(JSON.stringify({
    ...
    outputDir,
    files: [
      'customer-create-parity.json',
      'customer-update-parity.json',
      'customer-delete-parity.json',
    ],
