...
try {
  ...
  const missingInventoryItemIdResponse = await runGraphqlAllowGraphqlErrors(inventoryAdjustMutation, missingInventoryItemIdVariables);
  ...
  const missingLocationIdResponse = await runGraphqlAllowGraphqlErrors(inventoryAdjustMutation, missingLocationIdVariables);
