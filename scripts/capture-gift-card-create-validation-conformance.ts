...
const schemaQuery = `#graphql
  query GiftCardCreateValidationSchema {
...
const multipleSchemaErrorsMutation = `#graphql
  mutation GiftCardCreateMultipleSchemaErrors($input: GiftCardCreateInput!) {
    multipleErrors: giftCardCreate(input: $input) {
      giftCard {
        id
      }
      userErrors {
...
const multipleSchemaErrorsVariables = {
  input: {
    note: 'x',
...
const schema = await capture('schema', schemaQuery);
const multipleSchemaErrors = await capture(
  'multipleSchemaErrors',
  multipleSchemaErrorsMutation,
  multipleSchemaErrorsVariables,
);
  ...
  `${JSON.stringify(
    {
      ...
      proxyVariables: {
        ...
        multipleSchemaErrors: multipleSchemaErrorsVariables,
      },
      operations: {
        schema,
        multipleSchemaErrors,
