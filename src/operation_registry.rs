...
const LOCAL_DISPATCH_ROOTS: &[LocalDispatchRoot] = &[
    ...
    local_mutation("webPixelDelete", CapabilityDomain::OnlineStore),
    local_mutation("serverPixelCreate", CapabilityDomain::OnlineStore),
    local_mutation("serverPixelDelete", CapabilityDomain::OnlineStore),
    local_mutation(
    ...
    local_mutation("storefrontAccessTokenDelete", CapabilityDomain::OnlineStore),
    local_mutation(
