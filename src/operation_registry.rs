...
const LOCAL_DISPATCH_ROOTS: &[LocalDispatchRoot] = &[
    ...
    local_query("publication", CapabilityDomain::Products),
    local_query("channel", CapabilityDomain::Products),
    local_query("channels", CapabilityDomain::Products),
    local_query("publicationsCount", CapabilityDomain::Products),
    local_query("publishedProductsCount", CapabilityDomain::Products),
    ...
    local_query("paymentTermsTemplates", CapabilityDomain::Payments),
    ...
    local_mutation("customerAddressCreate", CapabilityDomain::Customers),
    local_mutation("customerAddressUpdate", CapabilityDomain::Customers),
    local_mutation("customerAddressDelete", CapabilityDomain::Customers),
    local_mutation("customerUpdateDefaultAddress", CapabilityDomain::Customers),
    local_query("storeCreditAccount", CapabilityDomain::Customers),
    local_mutation("storeCreditAccountCredit", CapabilityDomain::Customers),
    local_mutation("storeCreditAccountDebit", CapabilityDomain::Customers),
    ...
    local_mutation("companyLocationDelete", CapabilityDomain::B2b),
    local_mutation("companyLocationsDelete", CapabilityDomain::B2b),
    local_mutation("companyLocationAssignStaffMembers", CapabilityDomain::B2b),
    local_mutation("companyLocationRemoveStaffMembers", CapabilityDomain::B2b),
    ...
    local_mutation("productPublish", CapabilityDomain::Products),
    local_mutation("productUnpublish", CapabilityDomain::Products),
    ...
    local_query("article", CapabilityDomain::OnlineStore),
    local_query("articleAuthors", CapabilityDomain::OnlineStore),
    local_query("articles", CapabilityDomain::OnlineStore),
    local_query("articleTags", CapabilityDomain::OnlineStore),
    local_query("blog", CapabilityDomain::OnlineStore),
    local_query("blogs", CapabilityDomain::OnlineStore),
    local_query("blogsCount", CapabilityDomain::OnlineStore),
    local_query("page", CapabilityDomain::OnlineStore),
    local_query("pages", CapabilityDomain::OnlineStore),
    local_query("pagesCount", CapabilityDomain::OnlineStore),
    local_query("comment", CapabilityDomain::OnlineStore),
    local_query("comments", CapabilityDomain::OnlineStore),
    local_mutation("articleCreate", CapabilityDomain::OnlineStore),
    local_mutation("articleUpdate", CapabilityDomain::OnlineStore),
    local_mutation("articleDelete", CapabilityDomain::OnlineStore),
    local_mutation("blogCreate", CapabilityDomain::OnlineStore),
    local_mutation("blogUpdate", CapabilityDomain::OnlineStore),
    local_mutation("blogDelete", CapabilityDomain::OnlineStore),
    local_mutation("pageCreate", CapabilityDomain::OnlineStore),
    local_mutation("pageUpdate", CapabilityDomain::OnlineStore),
    local_mutation("pageDelete", CapabilityDomain::OnlineStore),
    local_mutation("commentApprove", CapabilityDomain::OnlineStore),
    local_mutation("commentSpam", CapabilityDomain::OnlineStore),
    local_mutation("commentNotSpam", CapabilityDomain::OnlineStore),
    local_mutation("commentDelete", CapabilityDomain::OnlineStore),
    local_mutation(
    ...
    local_mutation("orderClose", CapabilityDomain::Orders),
    local_mutation("orderOpen", CapabilityDomain::Orders),
    local_mutation("orderCancel", CapabilityDomain::Orders),
    local_mutation("orderDelete", CapabilityDomain::Orders),
    local_mutation("orderCustomerSet", CapabilityDomain::Orders),
    local_mutation("orderCustomerRemove", CapabilityDomain::Orders),
    local_mutation("fulfillmentCreate", CapabilityDomain::Orders),
    local_mutation("fulfillmentTrackingInfoUpdate", CapabilityDomain::Orders),
    local_mutation("fulfillmentCancel", CapabilityDomain::Orders),
    local_mutation("fulfillmentEventCreate", CapabilityDomain::Orders),
    local_query("fulfillment", CapabilityDomain::Orders),
    ...
    local_mutation("draftOrderUpdate", CapabilityDomain::Orders),
    local_mutation("draftOrderDuplicate", CapabilityDomain::Orders),
    local_mutation("draftOrderDelete", CapabilityDomain::Orders),
    local_mutation("draftOrderBulkDelete", CapabilityDomain::Orders),
    local_mutation("draftOrderCreateFromOrder", CapabilityDomain::Orders),
    local_mutation("draftOrderCalculate", CapabilityDomain::Orders),
    local_mutation("draftOrderInvoicePreview", CapabilityDomain::Orders),
    local_query("draftOrders", CapabilityDomain::Orders),
    local_query("draftOrdersCount", CapabilityDomain::Orders),
    local_mutation("orderEditBegin", CapabilityDomain::Orders),
    local_mutation("orderEditAddVariant", CapabilityDomain::Orders),
    local_mutation("orderEditSetQuantity", CapabilityDomain::Orders),
    local_mutation("orderEditAddCustomItem", CapabilityDomain::Orders),
    local_mutation("orderEditAddLineItemDiscount", CapabilityDomain::Orders),
    local_mutation("orderEditRemoveDiscount", CapabilityDomain::Orders),
    local_mutation("orderEditAddShippingLine", CapabilityDomain::Orders),
    local_mutation("orderEditUpdateShippingLine", CapabilityDomain::Orders),
    local_mutation("orderEditRemoveShippingLine", CapabilityDomain::Orders),
