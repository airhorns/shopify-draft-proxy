...
import shopify_draft_proxy/state/serialization/shared/decoders.{
  ...
  gift_card_decoder, market_decoder, market_localization_decoder,
  ...
  store_property_record_decoder, tax_app_configuration_decoder,
  translation_decoder, url_redirect_decoder, validation_decoder,
...
import shopify_draft_proxy/state/serialization/shared/serializers.{
  ...
  customer_catalog_page_info_json, customer_data_erasure_request_json,
  customer_event_summary_json, customer_json, customer_merge_request_json,
  customer_metafield_json, customer_order_summary_json,
  customer_payment_method_json, customer_payment_method_update_url_json,
  customer_segment_members_query_json, delegated_access_token_json,
  deleted_online_store_ids_json, delivery_profile_json,
  ...
  market_json, market_localization_json, marketing_engagement_json,
  ...
  tax_app_configuration_json, translation_json, url_redirect_json,
...
fn staged_state_dump_fields(state: store.StagedState) -> List(#(String, Json)) {
  [
    ...
    #(
      "marketingDeleteAllExternalInFlightApiClientIds",
      bool_dict_to_json(
        state.marketing_delete_all_external_in_flight_api_client_ids,
      ),
    ),
...
pub fn staged_state_decoder() -> Decoder(store.StagedState) {
  ...
  use marketing_delete_all_external_in_flight_api_client_ids <- optional_field(
    "marketingDeleteAllExternalInFlightApiClientIds",
    empty.marketing_delete_all_external_in_flight_api_client_ids,
  ...
  decode.success(store_types.StagedState(
    ...
    marketing_delete_all_external_in_flight_api_client_ids: marketing_delete_all_external_in_flight_api_client_ids,
