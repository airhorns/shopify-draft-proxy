...
fn access_token_not_found_user_error() -> UserError {
  UserError(
    field: [null_user_error_field_marker],
    message: "Access token does not exist.",
    code: Some("ACCESS_TOKEN_NOT_FOUND"),
  )
}

fn access_denied_user_error() -> UserError {
  UserError(
    field: [null_user_error_field_marker],
...
fn can_only_delete_delegate_tokens_user_error() -> UserError {
  UserError(
    field: [null_user_error_field_marker],
