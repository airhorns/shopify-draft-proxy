...
import shopify_draft_proxy/proxy/products/types.{
  ...
  MutationFieldResult, PrependReverseProducts, ProductUserError, RuleSetAbsent,
  RuleSetCustom, RuleSetSmart, blank_product_user_error,
  collection_handle_character_limit, collection_title_character_limit,
} as product_types
