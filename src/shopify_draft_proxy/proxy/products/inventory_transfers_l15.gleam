...
import shopify_draft_proxy/proxy/products/inventory_transfers_l14.{
  handle_inventory_transfer_cancel, handle_inventory_transfer_create,
  handle_inventory_transfer_duplicate, handle_inventory_transfer_edit,
  handle_inventory_transfer_mark_ready, handle_inventory_transfer_remove_items,
  handle_inventory_transfer_set_items,
}
import shopify_draft_proxy/proxy/products/shared_l01.{mutation_error_result}
