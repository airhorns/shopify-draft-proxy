...
import shopify_draft_proxy/proxy/products/product_types.{
  ...
  type VariantValidationProblem, NumericMissing, NumericNotANumber, NumericNull,
  NumericValue, ProductUserError, ProductVariantPositionInput,
  VariantValidationProblem, max_product_variants, max_variant_price,
