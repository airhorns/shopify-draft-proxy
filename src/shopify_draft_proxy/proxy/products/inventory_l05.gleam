...
import shopify_draft_proxy/proxy/products/inventory_l00.{
  find_inventory_level, inventory_compare_field_name, inventory_quantity_amount,
...
import shopify_draft_proxy/proxy/products/inventory_l01.{
  active_inventory_levels, add_inventory_quantity_amount,
  find_inventory_level_target, inventory_deactivate_only_state_error,
...
import shopify_draft_proxy/proxy/products/products_l04.{product_derived_summary}
...
import shopify_draft_proxy/proxy/products/types.{
  ...
  type InventoryMoveQuantityInput, type MutationFieldResult,
  type ProductTotalInventorySync, type ProductUserError,
