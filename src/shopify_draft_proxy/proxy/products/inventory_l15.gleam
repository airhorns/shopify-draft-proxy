...
import shopify_draft_proxy/proxy/products/inventory_l00.{
  valid_inventory_set_quantity_name,
}
import shopify_draft_proxy/proxy/products/inventory_l01.{
  invalid_inventory_set_quantity_name_error, read_inventory_set_quantity_inputs,
}
...
import shopify_draft_proxy/proxy/products/shared_l00.{read_bool_field}
