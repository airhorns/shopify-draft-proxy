...
import shopify_draft_proxy/proxy/products/shared_l00.{
  read_arg_object_list, read_arg_string_list, read_int_field, read_string_field,
}
...
import shopify_draft_proxy/proxy/products/types.{
  ...
  RecomputeProductTotalInventory, product_does_not_exist_user_error,
} as product_types
import shopify_draft_proxy/proxy/products/variants_l00.{
  find_product_option, position_options, restore_default_option_state,
  variant_staged_ids,
}
import shopify_draft_proxy/proxy/products/variants_l01.{
  insert_option_at_position, map_variants_to_first_new_option_values,
  remap_variant_to_first_option_values, reorder_variant_selections_for_options,
  sort_and_position_options, sync_product_options_with_variants,
  unknown_option_errors,
}
import shopify_draft_proxy/proxy/products/variants_l02.{
  apply_sequential_variant_reorder, first_bulk_delete_missing_variant,
...
import shopify_draft_proxy/proxy/products/variants_l03.{
  create_variants_for_option_value_combinations, make_created_option_records,
  update_product_option_record, upsert_variant_selections_into_options,
}
import shopify_draft_proxy/proxy/products/variants_l04.{
  make_options_from_variant_selections, validate_product_option_update_inputs,
}
import shopify_draft_proxy/proxy/products/variants_l05.{
  make_created_variant_record, update_variant_record,
}
import shopify_draft_proxy/proxy/products/variants_l06.{
  make_created_variant_records, update_variant_records,
  validate_product_variant_scalar_input,
}
import shopify_draft_proxy/proxy/products/variants_l07.{
...
import shopify_draft_proxy/proxy/products/variants_l12.{
  ...
  product_variant_payload, product_variants_bulk_delete_payload,
  product_variants_bulk_payload, product_variants_bulk_reorder_payload,
}
