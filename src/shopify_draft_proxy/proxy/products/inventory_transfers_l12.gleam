...
import shopify_draft_proxy/proxy/products/inventory_transfers_l00.{
  inventory_transfer_total_quantity,
}
import shopify_draft_proxy/proxy/products/inventory_transfers_l01.{
  inventory_transfer_location_source,
}
import shopify_draft_proxy/proxy/products/inventory_transfers_l11.{
  inventory_transfer_line_items_source,
}
import shopify_draft_proxy/proxy/products/shared_l00.{
  count_source, empty_connection_source,
}
