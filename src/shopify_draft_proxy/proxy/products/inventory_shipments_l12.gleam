...
import shopify_draft_proxy/proxy/products/inventory_shipments_l00.{
  inventory_shipment_tracking_source, shipment_line_item_total,
  shipment_total_accepted, shipment_total_rejected,
}
import shopify_draft_proxy/proxy/products/inventory_shipments_l01.{
  shipment_total_received,
}
import shopify_draft_proxy/proxy/products/inventory_shipments_l11.{
  inventory_shipment_line_items_source,
}
import shopify_draft_proxy/proxy/products/shared_l00.{count_source}
