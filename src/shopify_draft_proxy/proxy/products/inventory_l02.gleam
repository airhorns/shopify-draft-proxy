...
import shopify_draft_proxy/proxy/products/inventory_l00.{
  find_inventory_level, inventory_level_cursor, inventory_level_is_active,
  inventory_level_item_id, inventory_quantity_amount,
  normalize_inventory_item_id, valid_inventory_adjust_quantity_name,
  valid_staged_inventory_quantity_name,
}
import shopify_draft_proxy/proxy/products/inventory_l01.{
  active_inventory_levels, find_variable_definition_location_in_definitions,
  ...
  inventory_deactivate_location_deleted_error, inventory_level_source,
  inventory_properties_source, inventory_quantity_bounds_errors,
  inventory_set_quantity_bounds_errors, optional_weight_source, quantity_problem,
  read_inventory_move_terminal, read_inventory_quantities_available_total,
  read_inventory_weight_input, read_variant_weight_input,
  upsert_product_set_quantity_group, validate_inventory_move_ledger_document_uri,
...
import shopify_draft_proxy/proxy/products/shared_l00.{
  bool_string, dedupe_preserving_order, read_int_field, read_object_field,
  read_object_list_field, read_string_argument, read_string_field,
}
import shopify_draft_proxy/proxy/products/shared_l01.{
  connection_page_info_source, nullable_field_user_errors_source,
  read_include_inactive_argument, read_non_empty_string_field,
  read_numeric_field, resource_id_matches,
}
import shopify_draft_proxy/proxy/products/types.{
  ...
  ProductSetInventoryQuantityInput, ProductUserError, VariantValidationProblem,
