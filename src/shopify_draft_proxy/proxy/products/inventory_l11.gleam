...
import shopify_draft_proxy/proxy/products/inventory_l00.{
  inventory_adjustment_app_source,
}
import shopify_draft_proxy/proxy/products/inventory_l01.{
  find_inventory_level_target,
}
...
import shopify_draft_proxy/proxy/products/inventory_l10.{
  inventory_adjustment_change_source, inventory_item_update_payload,
  inventory_level_source_with_item, serialize_inventory_item_object,
}
