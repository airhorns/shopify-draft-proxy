...
import shopify_draft_proxy/proxy/products/collections_l00.{
  collections_published_to_publication,
}
...
import shopify_draft_proxy/proxy/products/publications_l02.{
  optional_channel_source,
}
import shopify_draft_proxy/proxy/products/publications_l06.{
  publication_products_connection_source,
}
