...
import shopify_draft_proxy/proxy/products/products_l00.{product_cursor}
import shopify_draft_proxy/proxy/products/products_l01.{
  product_numeric_id, read_product_status_field, updated_product_seo,
}
import shopify_draft_proxy/proxy/products/products_l02.{
  product_handle_should_dedupe, product_tags_validation_errors,
  read_explicit_product_handle, slugify_product_handle,
}
...
import shopify_draft_proxy/proxy/products/shared_l00.{
  count_source, empty_connection_source, read_string_argument, read_string_field,
