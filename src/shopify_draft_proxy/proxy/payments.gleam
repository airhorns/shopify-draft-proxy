...
import shopify_draft_proxy/state/types.{
  ...
  type Money, type OrderRecord, type PaymentCustomizationRecord,
  type PaymentScheduleRecord, type PaymentTermsRecord,
  type PaymentTermsTemplateRecord, CapturedBool, CapturedNull, CapturedObject,
