...
pub fn default_registry() -> List(RegistryEntry) {
  [
    ...
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage article deletion until real conformance evidence proves job shape, selector semantics, and downstream cascade behavior.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage article publication until real conformance evidence proves job shape, selector semantics, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage article unpublication until real conformance evidence proves job shape, selector semantics, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage article tag changes until real conformance evidence proves job shape, selector semantics, tag normalization, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage article tag removal until real conformance evidence proves job shape, selector semantics, tag normalization, and downstream reads.",
      ),
    ),
    RegistryEntry(
      name: "blog",
    ...
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage blog deletion until real conformance evidence proves job shape, selector semantics, and article/comment cascade behavior.",
      ),
    ),
    RegistryEntry(
      name: "page",
    ...
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage page deletion until real conformance evidence proves job shape, selector semantics, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage page publication until real conformance evidence proves job shape, selector semantics, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage page unpublication until real conformance evidence proves job shape, selector semantics, and downstream reads.",
      ),
    ),
    RegistryEntry(
      name: "comment",
    ...
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage comment approval until real conformance evidence proves job shape, selector semantics, moderation transitions, and downstream reads.",
      ),
    ),
    RegistryEntry(
      ...
      runtime_tests: [],
      support_notes: Some(
        "Public Admin GraphQL schema evidence for 2026-04 does not expose this Core online-store bulk root. The proxy returns a non-null local userErrors fallback and must not stage comment deletion until real conformance evidence proves job shape, selector semantics, true-destroy behavior, and downstream reads.",
      ),
    ),
    RegistryEntry(
