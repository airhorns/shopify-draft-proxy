  ...
  case validation_errors {
    ...
    [] -> {
      ...
      let user_errors = case input {
        Some(input_dict) ->
          validate_webhook_subscription_create_input(input_dict, topic, store)
        None -> []
      }
...
fn validate_webhook_subscription_create_input(
  ...
  let errors =
    validate_webhook_subscription_input(input, require_uri: True)
...
fn validate_webhook_subscription_update_input(
  ...
  validate_webhook_subscription_input(input, require_uri: False)
