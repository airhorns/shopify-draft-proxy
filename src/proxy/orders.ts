...
function normalizeOrderLineItems(raw: unknown, currencyCode: string): OrderLineItemRecord[] {
  ...
  return raw
    ...
    .map((lineItem) => {
      ...
      const priceSet = lineItem['priceSet'] ?? lineItem['originalUnitPriceSet'];
      ...
      return {
        ...
        originalUnitPriceSet: normalizeMoneyBag(priceSet, currencyCode, fallbackPrice),
...
function buildOrderFromInput(input: unknown): OrderRecord {
  ...
  return {
    ...
    paymentGatewayNames: normalizedTransactions
