use super::*;
use crate::proxy::request_context::RequestCacheKey;
...
impl DraftProxy {
    ...
    pub(in crate::proxy) fn bounded_connection_overlay_window(
        ...
        let cache_key = RequestCacheKey::new(
            "connection-overlay-window",
            overlay_connection_cache_key(request, &overlay, plan),
        );
        ...
        self.execution_session
            .request_cache
            .record_cached_value(cache_key, window.clone());
        window
    }
}
