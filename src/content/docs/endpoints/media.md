...
- `config/parity-specs/media/file_update_missing_id_coercion.json` captures
  `fileUpdate` omitted-`id` input coercion and the supplied-but-unknown-id
  `FILE_DOES_NOT_EXIST` contrast.
