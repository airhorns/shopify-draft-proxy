...
struct StagedState {
    ...
    online_store_sales_channel_baselines: BTreeSet<String>,
    ...
    online_store_content_baselines: BTreeSet<String>,
    ...
    url_redirects_baseline_loaded: bool,
    url_redirects_count_base: Option<usize>,
